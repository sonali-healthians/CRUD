...
<body>
  ...
  <form action="<?php echo base_url().'main/create'?>" name="registerForm" id="registerForm" method="post">
...
<div class="form-group">
        ...
        <a href="<?php echo base_url().'main/index';?>" class ="btn-secondary btn"> CANCEL</a>
</div>
</div>
